            ...
            if($fileError === 0)
            {
                if($fileSize < 5000000)
                {
                    ...
                    */
                    ...
                    $q="INSERT INTO `memory_database`(`email_id`, `memory_title`, `memory_discription`, `file_location`, `nominee_name`, `nominee_email`) VALUES ('$username','$memoryName','$memoryDescription','$fileName','$nomineeName','$nomineeEmail')";
